...
class DB_MYSQL {
	...
	function __construct($Database = MYSQL_DATABASE , $User = MYSQL_USER , $Pass = MYSQL_PASS , $Server = MYSQL_SERVER , $Port = MYSQL_PORT , $Socket = MYSQL_SOCKET ) {
